...
const geminiResponse = async (command, assistantName,userName) => {
    try {
        ...
        | "gmail_open" | "whatsapp_open" | "news_read" | "get_year" |"weather_show", 
        ...
        -"news_read": if user wants to hear latest news headlines. Respond with actual 3 current news headlines in the "response" field.
        -"get_year": if user asks for current year.
